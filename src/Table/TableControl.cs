...
namespace WindowsTableControl
{
    ...
    public class TableControl
    {
        ...
        public TableControl(Color backgroundColor, Brush backgroundBrush, Image backgroundPicture, Rectangle bounds, CellInformation tag)
        {
            //赋值
            this._backgroundColor = backgroundColor;
            this._backgroundBrush = backgroundBrush;
        ...
        private CellInformation _tag;
        /// <summary>获取与设置存储包含控件数据的对象
        /// 
        /// </summary>
        public CellInformation Tag
        {
            get
            {
                return this._tag;
