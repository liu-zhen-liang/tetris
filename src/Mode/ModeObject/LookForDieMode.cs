...
{
    /// <summary>无尽模式
    /// 一开始就最普通模式初始速度1关速度慢慢递增到24关，直到死亡
    /// </summary>
    public class LookForDieMode : ModeBase, IDisposable
    {
        /// <summary>创建无尽模式对象并设置初始值
        /// 
        /// </summary>
        ...
        public LookForDieMode(GameBase game, Table table, int seed, int id)
        ...
        public override void MoveToTheEnd(Player play)
        {
            ...
            //判断是否大于24如果大于就设置为24
            if (customsPass > 24) customsPass = 24;
            //判断关卡是否对应，如果对应就不设置
