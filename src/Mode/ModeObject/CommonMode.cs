...
{
    /// <summary>普通模式对象
    /// 总共有24个关卡，关卡越靠后方块下落速度也越快，【关卡计算：每消除20行加一个关卡】【分数计算：每消除一行底分150，连着消除两行第一行：150，第二行分数：150+100分，连着消除三行：第一行：150，第二行150+100，第三行150+200】
    /// </summary>
    public class CommonMode : ModeBase, IDisposable
    {
        ...
        public CommonMode(GameBase game, Table table, int seed, int id)
