...
{
    /// <summary>马拉松模式
    /// 每一万分加一个关卡速度，总共有32关速度
    /// </summary>
    public class MarathonMode : ModeBase, IDisposable
    {
        /// <summary>创建马拉松模式对象并设置初始值
        /// 
        /// </summary>
        ...
        public MarathonMode(GameBase game, Table table, int seed, int id)
        ...
        public override void MoveToTheEnd(Player play)
        {
            ...
            //通过消除行数来设置关卡
            //得到现在的行数：每一万分就加一关
            int customsPass = (base.Fraction / 10000) + (base.Fraction % 10000 == 0 ? 0 : 1);
