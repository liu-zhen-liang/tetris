...
namespace LZLTetris.ConventionShape
{
    ...
    /// 
    /// </summary>
    public class TetrisItme_T : TetrisItmeBase
    {
        ...
        /// 
        /// </summary>
        public static Color FixedShowColor = Color.FromArgb(0, 0, 255);
        /// <summary>私有构造函数【用于赋值】
        /// 
        /// </summary>
        private TetrisItme_T()
        {
            //设置当前俄罗斯方块的形态数量
            base._formCount = 4;
            ////设置Guid值
            //base._id = new Guid("9CD0EE03-A876-42E1-89E6-0C33A88EEA12");
            //设置当前形状显示的颜色
            base._showColor = TetrisItme_T.FixedShowColor;
        }
        /// <summary>创建该形状对象并赋值
        /// 
        /// </summary>
        ...
        public TetrisItme_T(int form, Table containerTable, int upIndex)
            : this()
        {
            //设置输入的形态值
            base._form = form;
            ...
            TableIndex[] ti = TetrisItme_T.ModelList[form].ToArray();
            ...
            //设置缩略图的位置
            base._breviary = TetrisItme_T.BreviaryList[form];
        }
        /// <summary>旋转方法，将当前T字型形状进行旋转
        /// 
        /// </summary>
