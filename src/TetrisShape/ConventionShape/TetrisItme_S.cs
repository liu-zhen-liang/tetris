...
namespace LZLTetris.ConventionShape
{
    ...
    /// 
    /// </summary>
    public class TetrisItme_S : TetrisItmeBase
    {
        ...
        /// 
        /// </summary>
        public static Color FixedShowColor = Color.FromArgb(128, 0, 0);
        /// <summary>私有构造函数【用于赋值】
        /// 
        /// </summary>
        private TetrisItme_S()
        {
            //设置当前俄罗斯方块的形态数量
            base._formCount = 2;
            ////设置Guid值
            //base._id = new Guid("B0FE6787-EA36-4F37-BE12-470AF563DEEF");
            //设置当前形状的颜色
            base._showColor = TetrisItme_S.FixedShowColor;
        }
        /// <summary>创建该形状对象并赋值
        /// 
        /// </summary>
        ...
        public TetrisItme_S(int form, Table containerTable, int upIndex)
            : this()
        {
            //设置输入的形态值
            base._form = form;
            ...
            TableIndex[] ti = TetrisItme_S.ModelList[form].ToArray();
            ...
            //设置缩略图的位置
            base._breviary = TetrisItme_S.BreviaryList[form];
        }
        /// <summary>旋转方法，将当前S字型形状进行旋转
        /// 
        /// </summary>
        ...
        public override bool Spin()
        {
            ...
            if (base._form == 0)
            {
                //将第一个索引位置加上：(2,0)，行加二，列加零
                ti[0] += new TableIndex(2, 0);
