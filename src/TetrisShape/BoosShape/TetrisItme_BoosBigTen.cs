...
namespace LZLTetris.TetrisShape.BossShape
{
    ...
    /// 
    /// </summary>
    public class TetrisItme_BossBigTen : TetrisItmeBossBase
    {
        ...
        /// 
        /// </summary>
        private TetrisItme_BossBigTen()
        {
            //设置当前俄罗斯方块的形态数量
            base._formCount = TetrisItme_BossBigTen.ModelList.Length;
            //设置当前形状显示的颜色
            base._showColor = TetrisItme_BossBigTen.FixedShowColor;
            //固定颜色
            base._fixedColor = TetrisItme_BossBigTen.FastenColor;
            //方块颜色是否为固定集合
            base._isFixedColorList = TetrisItme_BossBigTen.IsFixedColours;
        }
        /// <summary>创建该形状对象并赋值
        /// 
        /// </summary>
        ...
        public TetrisItme_BossBigTen(int form, Table containerTable, int upIndex)
            : this()
        {
            //设置输入的形态值
            base._form = form;
            ...
            TableIndex[] ti = TetrisItme_BossBigTen.ModelList[form].ToArray();
            ...
            //设置缩略图的位置
            base._breviary = TetrisItme_BossBigTen.BreviaryList[form];
        }
