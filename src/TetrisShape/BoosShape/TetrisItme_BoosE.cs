...
namespace LZLTetris.TetrisShape.BossShape
{
    ...
    /// 
    /// </summary>
    public class TetrisItme_BossE : TetrisItmeBossBase
    {
        ...
        /// 
        /// </summary>
        private TetrisItme_BossE()
        {
            //设置当前俄罗斯方块的形态数量
            base._formCount = TetrisItme_BossE.ModelList.Length;
            //设置当前形状显示的颜色
            base._showColor = TetrisItme_BossE.FixedShowColor;
            //固定颜色
            base._fixedColor = TetrisItme_BossE.FastenColor;
            //方块颜色是否为固定集合
            base._isFixedColorList = TetrisItme_BossE.IsFixedColours;
        }
        /// <summary>创建该形状对象并赋值
        /// 
        /// </summary>
        ...
        public TetrisItme_BossE(int form, Table containerTable, int upIndex)
            : this()
        {
            //设置输入的形态值
            base._form = form;
            ...
            TableIndex[] ti = TetrisItme_BossE.ModelList[form].ToArray();
            ...
            //设置缩略图的位置
            base._breviary = TetrisItme_BossE.BreviaryList[form];
        }
        /// <summary>旋转方法
        /// 
        /// </summary>
        ...
        public override bool Spin()
        {
            ...
            {
                //得到形态差
                TableIndex difference = TetrisItme_BossE.ModelList[form][i] - TetrisItme_BossE.ModelList[base._form][i];
                //加上形态差
                ti[i] += difference;
            }
            //判断旋转完毕是否合法
