...
namespace LZLTetris.TetrisShape.BossShape
{
    ...
    /// 
    /// </summary>
    public class TetrisItme_BossTen : TetrisItmeBossBase
    {
        ...
        /// 
        /// </summary>
        private TetrisItme_BossTen()
        {
            //设置当前俄罗斯方块的形态数量
            base._formCount = TetrisItme_BossTen.ModelList.Length;
            //设置当前形状显示的颜色
            base._showColor = TetrisItme_BossTen.FixedShowColor;
            //固定颜色
            base._fixedColor = TetrisItme_BossTen.FastenColor;
            //方块颜色是否为固定集合
            base._isFixedColorList = TetrisItme_BossTen.IsFixedColours;
        }
        /// <summary>创建该形状对象并赋值
        /// 
        /// </summary>
        ...
        public TetrisItme_BossTen(int form, Table containerTable, int upIndex)
            : this()
        {
            //设置输入的形态值
            base._form = form;
            ...
            TableIndex[] ti = TetrisItme_BossTen.ModelList[form].ToArray();
            ...
            //设置缩略图的位置
            base._breviary = TetrisItme_BossTen.BreviaryList[form];
        }
        /// <summary>旋转方法
        /// 
        /// </summary>
