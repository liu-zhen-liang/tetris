...
namespace LZLTetris.TetrisShape.BossShape
{
    ...
    /// 
    /// </summary>
    public class TetrisItme_BossBy : TetrisItmeBossBase
    {
        ...
        /// 
        /// </summary>
        private TetrisItme_BossBy()
        {
            //设置当前俄罗斯方块的形态数量
            base._formCount = TetrisItme_BossBy.ModelList.Length;
            //设置当前形状显示的颜色
            base._showColor = TetrisItme_BossBy.FixedShowColor;
            //固定颜色
            base._fixedColor = TetrisItme_BossBy.FastenColor;
            //方块颜色是否为固定集合
            base._isFixedColorList = TetrisItme_BossBy.IsFixedColours;
        }
        /// <summary>创建该形状对象并赋值
        /// 
        /// </summary>
        ...
        public TetrisItme_BossBy(int form, Table containerTable, int upIndex)
            : this()
        {
            //设置输入的形态值
            base._form = form;
            ...
            TableIndex[] ti = TetrisItme_BossBy.ModelList[form].ToArray();
            ...
            //设置缩略图的位置
            base._breviary = TetrisItme_BossBy.BreviaryList[form];
        }
        /// <summary>旋转方法
        /// 
        /// </summary>
        ...
        public override bool Spin()
        {
            ...
            {
                //得到形态差
                TableIndex difference = TetrisItme_BossBy.ModelList[form][i] - TetrisItme_BossBy.ModelList[base._form][i];
                //加上形态差
                ti[i] += difference;
            }
            //判断旋转完毕是否合法
